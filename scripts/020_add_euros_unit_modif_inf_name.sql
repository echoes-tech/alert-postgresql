...
UPDATE "T_INFORMATION_INF" SET "INF_NAME"='Montant-Panier-NC-Moyen' WHERE "SEA_ID"=4 AND "SRC_ID"=3 AND "PLG_ID_PLG_ID"=8 AND "INF_VALUE_NUM"=1 AND "INU_ID_INU_ID"=12;
