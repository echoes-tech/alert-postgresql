...
-- Table: "T_ASSET_ARCHITECTURE_AAR"

-- DROP TABLE "T_ASSET_ARCHITECTURE_AAR";

CREATE TABLE "T_ASSET_ARCHITECTURE_AAR"
(
  "ASA_ID" serial NOT NULL,
  version integer NOT NULL,
  "ASA_NAME" text NOT NULL,
  "ASA_DELETE" timestamp without time zone,
  CONSTRAINT "T_ASSET_ARCHITECTURE_AAR_pkey" PRIMARY KEY ("ASA_ID" )
)
WITH (
  OIDS=FALSE
);
ALTER TABLE "T_ASSET_ARCHITECTURE_AAR"
  OWNER TO echoes;
...
(
  ...
  CONSTRAINT "fk_T_PROBE_PACKAGE_PARAMETER_PPP_PPP_ASA" FOREIGN KEY ("PPP_ASA_ASA_ID")
      REFERENCES "T_ASSET_ARCHITECTURE_AAR" ("ASA_ID") MATCH SIMPLE
...
UPDATE "T_ASSET_AST" ast1 SET ast1."AST_ASA_ASA_ID" = ast1."AST_ARCHITECTURE";
UPDATE "T_ASSET_AST" ast1 SET ast1."AST_ASD_ASD_ID" = ast1."AST_DISTRIB_NAME";
UPDATE "T_ASSET_AST" ast1 SET ast1."AST_ASR_ASR_ID" = ast1."AST_DISTRIB_RELEASE";
